...
export default function Home() {
	return (
		<>
		<Navbar />
		<div className="p-5 mx-auto sm:p-10 md:p-16 dark:bg-stone-400  dark:text-gray-100 bg-cover h-screen">
			<div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
				<img src="https://source.unsplash.com/random/480x360" alt="" className="w-full h-60 sm:h-96 dark:bg-gray-500" />
				<div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-zinc-700">
