...
export default function Blog (){
    return(
        ...
        <>
        <Navbar/>
        <section className="dark:bg-stone-400 dark:text-gray-100">
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
		...
		<div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
			<a rel="noopener noreferrer" href="#" className="max-w-sm mx-auto group hover:no-underline focus:no-underline dark:bg-slate-800">
		...
		<div className="flex justify-center">
			<button type="button" className="px-6 py-3 text-sm rounded-md hover:underline dark:bg-gray-900 dark:text-gray-400" fdprocessedid="gktt2r">Load more posts...</button>
		</div>
	</div>
</section>
